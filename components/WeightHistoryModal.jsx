          ...
          <div style={{ borderTop: "1px solid #FFD9C8", paddingTop: 16 }}>
            ...
            {mode === "semester" && (
              <div>
                ...
                <select style={{ ...css.select, marginBottom: 14 }} value={semYear} onChange={e => setSemYear(parseInt(e.target.value))}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  <div>
                    ...
                    <input style={css.input} type="number" placeholder="ej: 14.2" step="0.1" value={sem1} onChange={e => setSem1(e.target.value)} />
                  </div>
                  <div>
                    ...
                    <input style={css.input} type="number" placeholder="ej: 15.0" step="0.1" value={sem2} onChange={e => setSem2(e.target.value)} />
                  </div>
                </div>
            ...
            {mode === "weekly" && (
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 }}>
                  <select style={css.select} value={weekYear} onChange={e => { setWeekYear(parseInt(e.target.value)); setWeekData({ 1: "", 2: "", 3: "", 4: "" }); }}>
                    {years.map(y => <option key={y} value={y}>{y}</option>)}
                  </select>
                  <select style={css.select} value={weekMonth} onChange={e => { setWeekMonth(parseInt(e.target.value)); setWeekData({ 1: "", 2: "", 3: "", 4: "" }); }}>
