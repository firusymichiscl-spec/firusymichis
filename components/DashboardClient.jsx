            ...
            <div className="fade-up">
              <div className="card">
                ...
                {[
                  ...
                  [generoPalabra(petData.sex, "Adoptada/Rescatada", "Adoptado/Rescatado"), petData.is_adopted ? `${petData.adoption_type === "rescatada" ? generoPalabra(petData.sex, "Rescatada", "Rescatado") : generoPalabra(petData.sex, "Adoptada", "Adoptado")}${petData.adopted_date ? `, el ${formatDate(petData.adopted_date)}` : ""}` : "No"],
