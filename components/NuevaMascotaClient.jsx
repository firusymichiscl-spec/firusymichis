...
// haciendo falta acá porque este componente es el que realmente usa el
// hook (Lote K2 — antes esto era la página completa).
export default function NuevaMascotaClient() {
  return (
